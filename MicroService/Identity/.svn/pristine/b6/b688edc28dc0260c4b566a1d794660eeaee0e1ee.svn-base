...
using Feng.ErrorCode.Extensions;
...
namespace Feng.Identity
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            // 添加全局定时服务
            services.AddFengHostedService(builder => { builder.AddConfig(); });
            //// 添加链路追踪
        ...
        {
            // 日志,事件驱动日志
            loggerFactory.AddFengLog(app, "Feng.Identity.Api");
            // 文档
