using Feng.Core.LoadBalancer;
using Feng.Grpc.Client;
using Feng.Grpc.Extensions;
...
namespace GrpcClientTest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 服务发现地址
            var endpoints = _loadBalancerHouse.Get("Feng.Grpc.Server").Result;
            ...
            for (var i = 0; i < 10000; i++)
            {
                ...
                var result = hello.Hello("hello word").GetAwaiter().GetResult();
